...
The PRD v1.4 calculation uses the dimensionless transfer variable
...
The fixed v1.4 classification contains 64 whole-class certificates, 33
...
class. This certifies 18 of the 21 points left unresolved in v1.1.

`finite_bandwidth_prd_v1_4.py` also performs three independent finite-basis
audits:
...
The archived outputs are in `results/prd_v1_4/`. The older scripts and tables
